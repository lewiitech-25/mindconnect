...
const counselors = [
  {
    ...
    name: 'Dr. Jane Smith',
    specialty:
      'Clinical Psychologist (Anxiety & CBT)',
    description:
      'Over 12 years supporting students with academic panic, grounding, and cognitive restructuring.',
  ...
  },
  {
    ...
    name: 'Dr. John Doe',
    specialty:
      'Licensed Clinical Counselor (Stress & Burnout)',
    description:
      'Expert in stress management, sleep hygiene, and creating work-life boundaries during college.',
  ...
  },
  {
    ...
    name: 'Dr. Karen Vance',
    specialty:
      'Academic Wellness Advisor (Life Transitions)',
    description:
      'Helping students handle adjustment fatigue, homesickness, and interpersonal relationships.',
...
const getUpcomingDays = () => {
  ...
  for (let index = 1; index <= 14; index += 1) {
    ...
    if (
      ['Monday', 'Tuesday', 'Wednesday'].includes(
        dayName
      )
    ) {
      days.push({
        dayName,
        dateString: nextDay.toLocaleDateString(
          undefined,
          {
            month: 'short',
            day: 'numeric',
        ...
        dateValue: nextDay.toISOString().split('T')[0]
      })
    }
...
export default function Counseling() {
  ...
  const isTimeSlotAlreadyBooked = (
    ...
    existingAppointments.some(
      (appointment) =>
        ...
        (
          appointment.dateValue === day.dateValue ||
          appointment.date === day.dateString
        ) &&
  ...
  const handleBooking = async () => {
    ...
    if (duplicateAppointment) {
      setBookingError(
        'You already have an appointment with this counsellor at the selected date and time.'
      )
      return
    }
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-50 pl-0 md:pl-64 flex items-center justify-center">
      ...
      <main className="p-6 max-w-4xl mx-auto space-y-6">
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-500 max-w-xl">
            Book a confidential consultation with a clinical
            psychologist or academic wellness adviser.
            Sessions are free for registered students.
          </p>
        </div>
          ...
          <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm space-y-6">
            ...
            {step === 1 && (
              <div className="space-y-4 animate-in fade-in duration-300">
                <h3 className="font-poppins font-bold text-sm text-text-custom">
                  ...
                  {counselors.map((counselor) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full p-4 rounded-xl border transition-all cursor-pointer flex items-start space-x-4 hover:shadow-sm text-left ${
                          active
                      ...
                      >
                        <div
                          className={`h-11 w-11 rounded-full shrink-0 flex items-center justify-center font-bold text-lg border border-slate-100 ${counselor.avatarColor}`}
                        >
                          <FaUserMd />
                        </div>
                        ...
                        <div className="flex-1 space-y-1">
                          <div className="flex items-center justify-between gap-3">
                            <h4 className="font-poppins font-bold text-sm text-text-custom">
                              {counselor.name}
                            </h4>
            ...
            {step === 3 && (
              <div className="space-y-6 animate-in fade-in duration-300">
                ...
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 space-y-2">
                  <h4 className="font-poppins font-bold text-xs text-text-custom border-b border-slate-200/50 pb-1.5 uppercase tracking-wide">
                    Booking Summary
                  </h4>
                ...
                <div className="flex justify-between items-center pt-4 border-t border-slate-50">
                  <button
                    ...
                    onClick={() => setStep(2)}
                    disabled={booking}
                    className="rounded-xl border border-slate-200 px-4 py-2.5 text-xs font-semibold text-slate-600 hover:bg-slate-50 disabled:opacity-50 transition-colors"
                  >
                    Back
                  </button>
                  ...
                  <button
                    ...
                    disabled={booking}
                    className="inline-flex items-center justify-center rounded-xl bg-primary px-6 py-2.5 text-xs font-bold text-white shadow-md shadow-primary/10 hover:bg-primary/95 disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-200"
                  >
                    {booking
                      ? 'Booking Session...'
